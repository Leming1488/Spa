...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  if (document.querySelector('.main-spa')) {
	    var shell = Array.prototype.slice.call(document.querySelectorAll('.main-spa'));
	    shell.forEach(function (container) {
	      return new _spa2.default(container);
	    });
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SpaShell = function () {
	  function SpaShell(container) {
	    (0, _classCallCheck3.default)(this, SpaShell);
	
	    this.container = container;
	    this.initModule();
	  }
	
	  (0, _createClass3.default)(SpaShell, [{
	    key: 'initModule',
